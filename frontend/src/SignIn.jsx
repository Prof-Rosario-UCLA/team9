...
export default function SignIn() {
  ...
  return (
    <div className="min-h-screen bg-base-200 flex items-center justify-center px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md bg-base-100 rounded-xl shadow-lg p-6 sm:p-8 overflow-y-auto">
        <h2 className="text-2xl sm:text-3xl font-bold text-center text-info mb-6">
